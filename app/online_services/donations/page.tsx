...
const taxExemptDonations = [
  { name: "Annadhanam (80G)", href: "#", icon: <Utensils className="w-6 h-6" />, desc: "Feeding the hungry" },
  { name: "Hospital Donations (80G)", href: "#", icon: <Stethoscope className="w-6 h-6" />, desc: "Medical aid for the poor" },
  { name: "Women Welfare (80G)", href: "#", icon: <Users className="w-6 h-6" />, desc: "Empowering women" }
];
