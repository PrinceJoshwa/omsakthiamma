...
// import { motion, AnimatePresence } from 'framer-motion';
// import { Calendar, AlertCircle, Search, Phone } from 'lucide-react';
// import { useState } from 'react';

// // FULL DATA FROM IMAGE 1 (July 01 2026 - July 31 2026)
// const scheduleData = [
//   { date: '01.07.2026', day: 'Wednesday', reg: 'RNE-04 & RNE-12', mandram: 'நடராஜபுரம் & புது மாயக்குளம்', district: 'இராமநாதபுரம்' },
//   { date: '02.07.2026', day: 'Thursday', reg: 'DGN-09', mandram: 'இலட்சுமிபுரம்', district: 'திண்டுக்கல்' },
//   { date: '03.07.2026', day: 'Friday', reg: 'KUN-04', mandram: 'ஏந்தல்', district: 'கள்ளக்குறிச்சி' },
//   { date: '04.07.2026', day: 'Saturday', reg: 'CDN-17', mandram: 'திருவள்ளுவர் நகர்', district: 'கடலூர்' },
//   { date: '05.07.2026', day: 'Sunday', reg: 'TJS-62', mandram: 'எண்கண்', district: 'தஞ்சாவூர்' },
//   { date: '06.07.2026', day: 'Monday', reg: 'MDE-07', mandram: 'சர்வேயர் காலனி', district: 'மதுரை' },
//   { date: '07.07.2026', day: 'Tuesday', reg: 'TMCG', mandram: 'செங்கம் வட்ட மன்றங்கள்', district: 'திருவண்ணாமலை' },
//   { date: '08.07.2026', day: 'Wednesday', reg: 'MDW-14', mandram: 'T.கல்லுப்பட்டி', district: 'மதுரை' },
//   { date: '09.07.2026', day: 'Thursday', reg: 'KSW-24', mandram: 'அகரம் பஜனை கோவில்', district: 'கிருஷ்ணகிரி' },
//   { date: '10.07.2026', day: 'Friday', reg: 'VPN-01', mandram: 'செஞ்சி', district: 'விழுப்புரம்' },
//   { date: '11.07.2026', day: 'Saturday', reg: 'MCI-14', mandram: 'கோயம்பேடு', district: 'மத்திய சென்னை' },
//   { date: '12.07.2026', day: 'Sunday', reg: 'KA-158', mandram: 'Seshadri Puram', district: 'Karnataka' },
//   { date: '13.07.2026', day: 'Monday', reg: 'NKS-03', mandram: 'மோகனூர்', district: 'நாமக்கல்' },
//   { date: '14.07.2026', day: 'Tuesday', reg: 'SS-02, SS-03, SS-40', mandram: 'ஆனி அமாவாசை வேள்வி - பெருந்துறை, புன்செய் புளியம்பட்டி, கோபிசெட்டி பாளையம் சக்திபீடங்கள்', district: 'ஈரோடு மாவட்டம்' },
//   { date: '15.07.2026', day: 'Wednesday', reg: 'RPE-50 & RPE-55', mandram: 'கொடியூர் இராமபுரம் & கொண்ட குப்பம்', district: 'இராணிப்பேட்டை' },
//   { date: '16.07.2026', day: 'Thursday', reg: 'VRSK-08', mandram: 'சிவகாசி', district: 'விருதுநகர்' },
//   { date: '17.07.2026', day: 'Friday', reg: 'TNE-05', mandram: 'தாழையூத்து', district: 'திருநெல்வேலி' },
//   { date: '18.07.2026', day: 'Saturday', reg: 'KA-159', mandram: 'Vayali Kaval', district: 'Karnataka' },
//   { date: '19.07.2026', day: 'Sunday', reg: 'NEN-01', mandram: 'Saraswathi Nagar', district: 'Nellore' },
//   { date: '20.07.2026', day: 'Monday', reg: 'KA-109', mandram: 'Chamraj Pet', district: 'Karnataka' },
//   { date: '21.07.2026', day: 'Tuesday', reg: 'PDS-04', mandram: 'அரசர்குளம்', district: 'புதுக்கோட்டை' },
//   { date: '22.07.2026', day: 'Wednesday', reg: 'SLW-27', mandram: 'தொப்பூர்', district: 'சேலம்' },
//   { date: '23.07.2026', day: 'Thursday', reg: 'TTW-11', mandram: 'கழுகுமலை', district: 'தூத்துக்குடி' },
//   { date: '24.07.2026', day: 'Friday', reg: 'KUS-06 & KUS-32', mandram: 'அம்மையகரம் & தென் பொன்பரப்பி', district: 'கள்ளக்குறிச்சி' },
//   { date: '25.07.2026', day: 'Saturday', reg: 'MDW-02', mandram: 'சம்பந்தமூர்த்தி நகர்', district: 'மதுரை' },
//   { date: '26.07.2026', day: 'Sunday', reg: 'TKS-12', mandram: 'பூபாலசமுத்திரம்', district: 'தென்காசி' },
//   { date: '27.07.2026', day: 'Monday', reg: 'KA-190', mandram: 'TP Street', district: 'Karnataka' },
//   { date: '28.07.2026', day: 'Tuesday', reg: 'TPN-18', mandram: 'பொன்னுசாமி கவுண்டர் வீதி', district: 'திருப்பூர்' },
//   { date: '29.07.2026', day: 'Wednesday', reg: 'SS-08', mandram: 'ஆடி பௌர்ணமி விளக்கு பூசை - சேலம் சக்திபீடம்', district: 'சேலம் மாவட்டம்' },
//   { date: '30.07.2026', day: 'Thursday', reg: 'TPN-15', mandram: 'பாரதி நகர்', district: 'திருப்பூர்' },
//   { date: '31.07.2026', day: 'Friday', reg: 'DGS-15', mandram: 'அய்யம்பாளையம்', district: 'திண்டுக்கல்' },
// ];
...
//             கருவறைப் பணி (Sanctum Service)
//           </h1>
//           <p className="text-gray-600">Detailed Schedule for July 01, 2026 - July 31, 2026</p>
//         </motion.div>
...
//                     </td>
//                     <td className="p-4 border-r border-gray-100 font-mono text-xs font-bold">{row.reg}</td>
//                     <td className="p-4 border-r border-gray-100 font-medium font-tamil leading-relaxed">{row.mandram}</td>
//                     <td className="p-4 font-bold text-gray-800 font-tamil">{row.district}</td>
//                   </tr>
//                 ))}
//               </tbody>
...
// FULL DATA FROM IMAGE (August 01, 2026 - August 31, 2026)
const scheduleData = [
  { date: '01.08.2026', day: 'Saturday', reg: 'TMA-01', mandram: 'ஆரணி பொது', district: 'திருவண்ணாமலை' },
  { date: '02.08.2026', day: 'Sunday', reg: 'KA', mandram: 'J.C. Nagar', district: 'Karnataka' },
  { date: '03.08.2026', day: 'Monday', reg: 'KA-648', mandram: 'Voccaleri', district: 'Karnataka' },
  { date: '04.08.2026', day: 'Tuesday', reg: 'MN-06', mandram: 'செங்குன்றம் - அம்பேத்கர் நகர்', district: 'வட சென்னை' },
  { date: '05.08.2026', day: 'Wednesday', reg: 'MCI-14', mandram: 'கோயம்பேடு', district: 'மத்திய சென்னை' },
  { date: '06.08.2026', day: 'Thursday', reg: 'KA-531', mandram: 'Kurubarapet', district: 'Karnataka' },
  { date: '07.08.2026', day: 'Friday', reg: 'DG-7', mandram: 'சிவிகிரிப்பட்டி', district: 'திண்டுக்கல்' },
  { date: '08.08.2026', day: 'Saturday', reg: 'VR-13', mandram: 'சாத்தூர்', district: 'விருதுநகர்' },
  { date: '09.08.2026', day: 'Sunday', reg: 'KS-176', mandram: 'விளங்காமுடி', district: 'கிருஷ்ணகிரி தெற்கு' },
  { date: '10.08.2026', day: 'Monday', reg: 'KRW-03', mandram: 'கரூர் மகளிர்', district: 'கரூர்' },
  { date: '11.08.2026', day: 'Tuesday', reg: 'TIW-29 & TIS-57', mandram: 'கேத்தாண்டப்பட்டி & மேட்டுக்கணியூர்', district: 'திருப்பத்தூர்' },
  { date: '12.08.2026', day: 'Wednesday', reg: 'SS-01, SS-11, SS-12, SS-65, SS-04, SS-23, SS-61, SS-62', mandram: 'ஆடி அமாவாசை வேள்வி - பாரதி நகர், ஹுட்கோ காலனி, ஓம்சக்தி நகர், சுந்தராபுரம் சக்திபீடங்கள் - கோவை மாவட்டம். திருப்பூர், புஷ்பவனம், வெள்ளக்கோவில், உடுமலைப்பேட்டை சக்திபீடங்கள் - திருப்பூர் மாவட்டம்.', district: 'கோவை & திருப்பூர்' },
  { date: '13.08.2026', day: 'Thursday', reg: 'CB & TP', mandram: 'ஆடிப்பூர பெருவிழா - கோவை & திருப்பூர் மாவட்ட மன்றங்கள்', district: 'கோவை & திருப்பூர்' },
  { date: '14.08.2026', day: 'Friday', reg: 'CB & TP', mandram: 'ஆடிப்பூர பெருவிழா - கோவை & திருப்பூர் மாவட்ட மன்றங்கள்', district: 'கோவை & திருப்பூர்' },
  { date: '15.08.2026', day: 'Saturday', reg: 'CB & TP', mandram: 'ஆடிப்பூர பெருவிழா - கோவை & திருப்பூர் மாவட்ட மன்றங்கள்', district: 'கோவை & திருப்பூர்' },
  { date: '16.08.2026', day: 'Sunday', reg: 'TKW-03', mandram: 'மேலகரம்', district: 'தென்காசி' },
  { date: '17.08.2026', day: 'Monday', reg: 'PDW-16', mandram: 'காந்தி நகர்', district: 'புதுக்கோட்டை' },
  { date: '18.08.2026', day: 'Tuesday', reg: 'KA-319', mandram: 'Devanahalli', district: 'Karnataka' },
  { date: '19.08.2026', day: 'Wednesday', reg: 'TES-24', mandram: 'கம்பம்', district: 'தேனி' },
  { date: '20.08.2026', day: 'Thursday', reg: 'TMPTW-42', mandram: 'ரெட்டியார்பாளையம்', district: 'திருவண்ணாமலை' },
  { date: '21.08.2026', day: 'Friday', reg: 'MDS-03', mandram: 'மகளிர்', district: 'மதுரை' },
  { date: '22.08.2026', day: 'Saturday', reg: 'RNW-03', mandram: 'புது நகர்', district: 'இராமநாதபுரம்' },
  { date: '23.08.2026', day: 'Sunday', reg: 'RPS-31', mandram: 'கனியனூர்', district: 'இராணிப்பேட்டை' },
  { date: '24.08.2026', day: 'Monday', reg: 'PEC-11', mandram: 'மங்கலமேடு', district: 'பெரம்பலூர்' },
  { date: '25.08.2026', day: 'Tuesday', reg: 'MDE-21', mandram: 'கீழையூர்', district: 'மதுரை' },
  { date: '26.08.2026', day: 'Wednesday', reg: 'SGS-10', mandram: 'மீனாட்சி நகர்', district: 'சிவகங்கை' },
  { date: '27.08.2026', day: 'Thursday', reg: 'SS-06', mandram: 'ஆவணி பௌர்ணமி விளக்கு பூசை - வாணியம்பாடி சக்திபீடம்', district: 'திருப்பத்தூர்' },
  { date: '28.08.2026', day: 'Friday', reg: 'TJE-41', mandram: 'வடுகச்சேரி', district: 'தஞ்சாவூர்' },
  { date: '29.08.2026', day: 'Saturday', reg: 'TES-06 & TES-09', mandram: 'உத்தமபாளையம்', district: 'தேனி' },
  { date: '30.08.2026', day: 'Sunday', reg: 'DPW-184', mandram: 'மாங்கரை', district: 'தர்மபுரி' },
  { date: '31.08.2026', day: 'Monday', reg: 'DPS', mandram: 'தர்மபுரி தெற்கு வட்ட மன்றங்கள்', district: 'தர்மபுரி' },
];
    ...
    <main className="min-h-screen bg-gray-50 py-12 px-4 md:px-8">
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <p className="text-gray-600">Detailed Schedule for August 01, 2026 - August 31, 2026</p>
        </motion.div>
