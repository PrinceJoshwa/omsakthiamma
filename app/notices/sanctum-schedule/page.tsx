...
// import { Calendar, Users, Clock, AlertCircle, Search } from 'lucide-react';
...
//   { date: '04.12.2025', day: 'Thursday', reg: 'SS13, SS19...', mandram: 'Annur, Thithipalayam, Press Colony, Karamadai, Mettupalayam', district: 'Coimbatore' },
...
//   { date: '21.12.2025', day: 'Sunday', reg: 'RNC-08...', mandram: 'Athiyuthu & Ponkulam', district: 'Ramanathapuram' },
...
//   { date: '26.12.2025', day: 'Friday', reg: 'TR 67...', mandram: 'Kalakkudi & Kavi Barathi Nagar', district: 'Trichy' },
...
//           </h1>
//           <p className="text-gray-600">Schedule for Dec 01, 2025 - Dec 31, 2025</p>
//         </motion.div>
...
//                   <th className="p-4 font-bold border-r border-red-800">Date & Day</th>
//                   <th className="p-4 font-bold border-r border-red-800">Reg No</th>
...
//                     </td>
//                     <td className="p-4 border-r border-gray-100 font-mono text-xs">{row.reg}</td>
//                     <td className="p-4 border-r border-gray-100 font-medium">{row.mandram}</td>
//                     <td className="p-4 font-bold text-gray-800">{row.district}</td>
//                   </tr>
//                 ))}
//               </tbody>
//             </table>
...
//         {/* Instructions Card (From Bottom of Image 1) */}
//         <motion.div 
//           initial={{ opacity: 0, y: 20 }}
//           animate={{ opacity: 1, y: 0 }}
//           transition={{ delay: 0.2 }}
//           className="bg-yellow-50 border-l-4 border-yellow-500 p-6 md:p-8 rounded-r-2xl shadow-sm"
//         >
//           <div className="flex items-center gap-3 mb-4">
//             <AlertCircle className="w-6 h-6 text-yellow-700" />
//             <h3 className="text-xl font-bold text-yellow-800 font-tamil">முக்கிய அறிவுரைகள் (Instructions)</h3>
//           </div>
          
//           <div className="grid md:grid-cols-2 gap-6 text-yellow-900/80 leading-relaxed font-tamil">
...
//               </li>
//               <li>
//                 அனைவரும் புறப்படும் இடத்திலிருந்து முழு சீருடையில் வரவேண்டும். மகளிர் கைத்தறி நூல் ஆடை அணிந்தவர்களாக இருக்கவேண்டும்.
//               </li>
//               <li>
//                 மந்திர நூல் முழுமையாக படிக்கத் தெரிந்தவர்கள் 10 பேராவது இருக்க வேண்டும்.
//               </li>
//             </ul>
//             <ul className="space-y-3 list-disc ml-5">
//               <li>
...
//               </li>
//               <li>
//                 2 சாக்கு (கோணிப்பை) அளவிற்கு வேப்பிலை கொண்டுவரவும்.
//               </li>
//               <li>
