...
{/* --- NEW: DOWNLOADABLE FORM SECTION (Moved right below Hero) --- */}
      <section className="py-12 bg-[#FAFAFA] relative z-20">
        <div className="max-w-6xl mx-auto px-4">
          <motion.div 
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            className="bg-gradient-to-br from-orange-50 to-white border border-red-100 rounded-3xl p-6 md:p-10 flex flex-col md:flex-row items-center justify-between gap-8 shadow-lg hover:shadow-xl transition-shadow relative overflow-hidden"
          >
            <div className="absolute -right-6 -bottom-6 text-red-50 opacity-40 pointer-events-none">
              <FileText className="w-64 h-64" />
            </div>
            
            <div className="relative z-10 flex-1 w-full text-left">
              <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-red-100/80 text-[#a7150b] text-xs font-bold uppercase tracking-wider mb-4">
                <Download className="w-3.5 h-3.5" />
                Offline Option
              </div>
              <h3 className="text-2xl md:text-3xl font-bold text-gray-900 mb-2 font-tamil">
                தொண்டர் தகவல் படிவம்
                <span className="block text-lg font-medium text-gray-500 font-sans mt-2">Official Volunteer Information Form</span>
              </h3>
              <p className="text-gray-600 text-base leading-relaxed mt-4 max-w-3xl">
                If you prefer manual registration or are registering for the upcoming <strong>Chithirai Pournami 2026</strong> Velvi, please download the physical form. Print the document, fill out your information clearly, attach a <strong>stamp-size photograph and your Aadhar copy</strong>, and submit it with the required signatures.
              </p>
            </div>
            ...
            <div className="relative z-10 w-full md:w-auto shrink-0">
              <a 
                ...
                download="Chithirai_Pournami_Volunteer_Form.pdf"
                target="_blank"
                rel="noopener noreferrer"
                className="w-full md:w-auto flex items-center justify-center gap-3 bg-[#a7150b] text-white px-8 py-5 rounded-2xl font-bold text-lg shadow-md hover:bg-[#8a0d08] hover:-translate-y-1 transition-all duration-300 whitespace-nowrap group"
              >
      ...
      {/* --- HOW TO APPLY (Timeline Style) --- */}
      <section className="py-16 bg-white border-b border-t border-gray-100">
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-2xl md:text-3xl font-bold text-[#1a1a1a]">Application Journey</h2>
            <div className="w-20 h-1 bg-[#a7150b] mx-auto mt-4 rounded-full opacity-20"></div>
      ...
      <section className="py-20 px-4 max-w-7xl mx-auto">
        <div className="grid lg:grid-cols-12 gap-12 items-start">
          ...
          {/* LEFT: Information Cards & FAQs (Span 7 cols) */}
          <div className="lg:col-span-7 space-y-6">
            <div className="mb-8">
              <h2 className="text-3xl font-bold text-gray-900 mb-4">Program Details</h2>
              <p className="text-gray-600">Everything you need to know before you apply.</p>
