...
// export default function EventBanner() {
//   const noticeImage = "https://res.cloudinary.com/dvd7o5nph/image/upload/v1781469049/hero-omsakthi_ti7zw5.jpg";
//   const detailedPoster = "https://res.cloudinary.com/dvd7o5nph/image/upload/v1785485905/WhatsApp_Image_2026-07-31_at_11.49.54_AM_1_u8iirc.jpg";
...
//         {/* --- 3. NEW SECTION: Detailed Program Poster --- */}
//         <motion.div 
...
//               விழா <span className="text-[#a7150b]">விவரங்கள்</span>
//             </h3>
//             <div className="w-16 h-1.5 bg-[#ffc107] mt-4 rounded-full"></div>
//           </div>

//           <div className="relative rounded-3xl overflow-hidden shadow-[0_20px_50px_rgba(167,21,11,0.15)] border-8 border-white group w-full max-w-3xl mx-auto bg-orange-100/50">
//             <Image 
//               src={detailedPoster} 
//               alt="Detailed Aadi Pooram Program Poster"
//               width={1000}
//               height={1400}
...
export default function EventBanner() {
  // Update this URL with your newly hosted Navarathri poster link
  const noticeImage = "/navaratri.jpeg";

  const schedule = [
    { date: "10.10.2026", tamilDay: "சனிக்கிழமை", title: "தங்கக்கவசம் புரட்டாசி அமாவாசை வேள்விபூஜை", color: "border-l-[#ffc107]" },
    { date: "11.10.2026", tamilDay: "ஞாயிறு", title: "மஞ்சள் காப்பு", color: "border-l-[#a7150b]" },
    { date: "12.10.2026", tamilDay: "திங்கள்", title: "ஜவ்வாதுக்காப்பு", color: "border-l-[#ffc107]" },
    { date: "13.10.2026", tamilDay: "செவ்வாய்", title: "குங்குமக்காப்பு", color: "border-l-[#a7150b]" },
    { date: "14.10.2026", tamilDay: "புதன்கிழமை", title: "விபூதிக்காப்பு", color: "border-l-[#ffc107]" },
    { date: "15.10.2026", tamilDay: "வியாழன்", title: "சந்தனக்காப்பு", color: "border-l-[#a7150b]" },
    { date: "16.10.2026", tamilDay: "வெள்ளி", title: "வேப்பிலைக்காப்பு", color: "border-l-[#ffc107]" },
    { date: "17.10.2026", tamilDay: "சனிக்கிழமை", title: "துளசிக்காப்பு", color: "border-l-[#a7150b]" },
    { date: "18.10.2026", tamilDay: "ஞாயிறு", title: "நவதானியக்காப்பு", color: "border-l-[#ffc107]" },
    { date: "19.10.2026", tamilDay: "திங்கள்", title: "கற்கண்டுக்காப்பு", color: "border-l-[#a7150b]" },
    { date: "20.10.2026", tamilDay: "செவ்வாய்", title: "உலர்பழங்கள் காப்பு", color: "border-l-[#ffc107]" }
  ];
  ...
  return (
    <section className="py-12 md:py-20 px-4 bg-orange-50/40">
      <div className="max-w-6xl mx-auto">
        ...
        {/* 50/50 equal split, items-center to balance vertically */}
        <div className="grid md:grid-cols-2 gap-10 md:gap-16 items-center">
          ...
          >
            ...
            <div>
              ...
              <h2 className="text-3xl md:text-5xl font-extrabold text-[#1a1a1a] mb-4 leading-tight">
                மேல்மருவத்தூர் ஆதிபராசக்தி சித்தர் பீடம் <br/>
                <span className="text-[#a7150b]">நவராத்திரி விழா 2026</span>
              </h2>
              <p className="text-gray-700 text-lg leading-relaxed font-medium">
                பக்தர்கள், தொண்டர்கள் நவராத்திரி காப்பு அபிடேகத்தில் கலந்து கொண்டு அருள்மிகு பங்காரு அம்மா அவர்களின் குருவருள் பெறுக..!!
              </p>
            </div>

            {/* Schedule List - fixed height & scroll for 11 items */}
            <div className="bg-white p-5 rounded-2xl shadow-sm border border-gray-100 space-y-4 max-h-[400px] overflow-y-auto pr-2 custom-scrollbar">
              {schedule.map((item, idx) => (
                <div key={idx} className={`flex items-center gap-4 p-3 bg-orange-50/50 rounded-xl border-l-4 ${item.color} transition-transform hover:translate-x-1 duration-300`}>
                  <div className="bg-white p-2 rounded-lg shadow-sm">
                    <Calendar className="w-5 h-5 text-[#a7150b]" />
            ...
            <div className="flex items-start gap-3 p-4 bg-red-50/50 rounded-xl border border-red-100">
              <MapPin className="w-6 h-6 text-[#a7150b] flex-shrink-0 mt-1" />
              <div>
                <p className="font-bold text-[#a7150b] text-sm mb-1">இடம்,</p>
                <p className="font-semibold text-gray-800 text-sm leading-snug">
          ...
          >
            <div className="relative rounded-2xl overflow-hidden shadow-2xl border-[6px] border-[#ffc107] group w-full max-w-md mx-auto md:max-w-full">
              <div className="aspect-[3/4] relative w-full bg-orange-100/50"> 
                <Image 
                  src={noticeImage} 
                  alt="Navarathri Festival 2026 Invitation Poster"
                  fill
                  className="object-fill"
                  priority
                />
